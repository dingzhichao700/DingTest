...
//class view.TestView extends laya.display.Sprite
var TestView=(function(_super){
	function TestView(){
		...
		for (var i=0;i < 11;i++){
			...
			sp2.blendMode=TestView.BLEND_MODES[i];
			box.addChild(sp2);
		}
	}
	...
	__static(TestView,
	['BLEND_MODES',function(){return this.BLEND_MODES=["source-atop","source-in","source-out","source-over","destiantion-atop","destination-in","destination-out","destination-over","lighter","copy","xor"];}
	]);
	return TestView;
})(Sprite)
...
var WebGLImage=(function(_super){
	...
	*/
	...
	Laya.__init([LoaderManager,EventDispatcher,Browser,Render,LocalStorage,WebGLContext2D,ShaderCompile,Timer,DrawText,AtlasGrid]);
	/**LayaGameStart**/
	new LayaUISample();

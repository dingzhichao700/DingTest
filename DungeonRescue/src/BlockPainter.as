package {
	...
	public class BlockPainter {
		...
		public function initMission(mission:int):void {
			blockDotList = [BLOCK_1, BLOCK_2, BLOCK_3];
			...
			finish ||= new Sprite();
			finish.graphics.clear();
			var finishBlock:Array = FINISH[mission-1];
			finish.graphics.beginFill(0xff0000);
			finish.graphics.drawCircle(finishBlock[0], finishBlock[1], 30);
			LayerManager.getInstance().LAYER_PLAYER.addChild(finish);
		}

package com.element {
	...
	public class ElementGenerator {
		...
		private static function setTextField(data:Object):void {
			Style.getTextField("<p valign='bottom' align='center'><font filter='#000000' color='#ffffff' face='Arial' size='12'>" + data.txtContent + "</font></p>", 0, data.height / 2 - 11, null, data.width, data.height, editEle);
		}

...
//				case "ComboBox":
		...
		private static function getCreationByEle(ele:Element):String {
			...
			switch (ele.type) {
				case "textField":
					str = "ComponentUtil.createTextField(\"" + ele.data.typeData.txtContent + "\", " + ele.x + ", " + ele.y + ", Style.commonPanelLeft, " + ele.data.typeData.width + ", " + ele.data.typeData.height + ", this)";
					break;
				case "bitmap": //位图的ele.data.typeData.txtContent放的是位图资源名称，如"abc.jpg"就是"abc"
					...
					break;
				case "button1":
					str = "ComponentUtil.createButton(\"" + ele.data.typeData.txtContent + "\", " + ele.x + ", " + ele.y + ", " + ele.data.typeData.width + ", " + ele.data.typeData.height + ", this, " + getListener() + ")";
					break;
				case "button2":
					str = "ComponentUtil.createButton(\"" + ele.data.typeData.txtContent + "\", " + ele.x + ", " + ele.y + ", " + ele.data.typeData.width + ", " + ele.data.typeData.height + ", this, " + getListener() + ")";
